...
public enum GameOfLifeCellState implements State {
    ...
    /**
     * Not currently sure how to implement this. Isn't the value of the
     * enum itself equivalent to "the state" of this enum? If that's the case,
     * I don't see why we need this method. I only know the very basics of enums
     * @return null
     */
    @Override
