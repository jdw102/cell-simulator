...
public class GridInputs {
     ...
     */
    public GridInputs(ViewUtils utils) {
        viewUtils = utils;
        Button backwardButton = viewUtils.makeButton("BackwardButton", event -> System.out.println("Backward"));
        playButton = new PlayButton(utils);
        Button forwardButton = viewUtils.makeButton("ForwardButton", event -> System.out.println("Forward"));
        viewUtils.attachTooltip("BackwardButtonTooltip", backwardButton);
        viewUtils.attachTooltip("ForwardButtonTooltip", forwardButton);
    ...
    private Slider makeSpeedSlider(TextField speedLabel) {
        ...
        s.setId("SpeedSlider");
        viewUtils.attachTooltip("SpeedSliderTooltip", s);
        return s;
    }
